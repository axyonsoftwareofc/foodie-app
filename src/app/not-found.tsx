  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Restaurante nao encontrado</h1>

        <p className="text-gray-500 mb-8">
          O endereco que voce acessou nao corresponde a nenhum restaurante ativo no Foodie.
          Verifique se digitou corretamente ou crie o seu proprio restaurante!
        </p>
