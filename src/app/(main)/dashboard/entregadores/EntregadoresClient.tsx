...
import { createDriverWithAuth } from '@/actions/delivery-actions';
import type { DeliveryDriver } from '@/types/delivery.types';

export function EntregadoresClient({ drivers }: { drivers: DeliveryDriver[] }) {
  // `drivers` vem do servidor por prop; createDriverWithAuth chama
  // revalidatePath, então a lista se atualiza sozinha após criar.
