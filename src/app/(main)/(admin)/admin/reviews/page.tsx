              ...
              {[5, 4, 3, 2, 1].map((star) => {
                ...
                return (
                  <div key={star} className="flex items-center gap-2">
                    <span className="text-sm w-3" style={{ color: 'var(--color-text-secondary)' }}>
                      {star}
                    </span>
      ...
      <div className="px-4 mb-4">
        <div className="flex gap-2 overflow-x-auto pb-2">
          <button
            ...
            style={{
              backgroundColor: filter === 'all' ? '#00A082' : 'var(--color-bg-card)',
          ...
          {[5, 4, 3, 2, 1].map((star) => (
            <button
              ...
              style={{
                backgroundColor: filter === String(star) ? '#00A082' : 'var(--color-bg-card)',
                color: filter === String(star) ? 'white' : 'var(--color-text-secondary)',
              }}
            >
              {star}{' '}
              <Star
                size={12}
                className={
                  filter === String(star) ? 'text-white' : 'text-yellow-400 fill-yellow-400'
                }
              />
            </button>
          ))}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  {review.response && (
                    ...
                    >
                      <p className="text-xs font-medium mb-1" style={{ color: '#00A082' }}>
