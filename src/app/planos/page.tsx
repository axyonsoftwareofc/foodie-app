...
const FAQ = [
  {
    q: 'Preciso pagar alguma coisa pra começar?',
    a: 'Nao. O plano Gratis e realmente gratis, sem taxa por pedido. Voce so paga quando fizer upgrade para o Pro ou Enterprise.',
  },
  {
    q: 'Quanto tempo leva pra montar o cardapio?',
    a: 'Em media 5 minutos. Nosso onboarding guiado em 3 passos te ajuda a cadastrar nome, endereco e aparencia do restaurante.',
  },
  {
    q: 'Meus clientes conseguem pagar com Pix?',
    a: 'Sim! O Pix ja vem ativado em todos os planos, sem custo adicional. Cartao de credito/debito disponivel no plano Pro.',
  },
  {
    q: 'Posso usar meu proprio dominio?',
    a: 'Sim, nos planos Pro e Enterprise. Basta configurar um registro CNAME no seu provedor de dominio.',
  },
  {
    q: 'Como recebo os pedidos?',
    a: 'Pelo painel da cozinha em tempo real, com notificacao sonora. Tambem pode ativar notificacoes por email.',
  },
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mt-2 mb-3">Escolha o plano ideal</h1>
          <p className="text-gray-500 max-w-lg mx-auto">
            Comece gratis e faca upgrade quando seu restaurante crescer. Sem taxa por pedido, sem
            surpresas.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 py-16">
        <h2 className="text-2xl font-bold text-gray-900 text-center mb-8">Duvidas frequentes</h2>
