...
import { getRestaurantProfile, updateRestaurantProfile, updateOperatingHours } from '@/actions/restaurantActions'
import type { RestaurantProfile, OperatingHours as MgmtOperatingHours } from '@/types/restaurant-management.types'
...
export default function SettingsPage() {
    ...
    const handleHourToggle = (index: number) => {
        setHours((prev) =>
            prev.map((h, i) => (i === index ? { ...h, isClosed: !h.isClosed } : h))
        )
    }
