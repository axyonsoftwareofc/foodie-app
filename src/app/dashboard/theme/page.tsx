    ...
    getRestaurantProfile().then((result) => {
      if (result.data) {
        ...
        if (result.data.theme) {
          try {
            const stored =
              typeof result.data.theme === 'string'
    ...
    <div className="max-w-2xl">
      ...
      <div className="space-y-6">
              ...
              >
                <div className="flex gap-1 mb-2">
                  <div
                    ...
                    style={{ backgroundColor: preset.theme.primaryColor || '#00A082' }}
                  />
                  <div
                    className="w-4 h-4 rounded"
                    style={{ backgroundColor: preset.theme.textColor || '#111' }}
                  />
                  <div
                    className="w-4 h-4 rounded border"
                    style={{ backgroundColor: preset.theme.cardBackgroundColor || '#FFF' }}
                  />
                </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {(
              [
                ...
                'textColor',
                'textSecondaryColor',
              ] as (keyof RestaurantTheme)[]
            ).map((field) => (
              <div key={field}>
                <label className="block text-xs text-gray-500 mb-1">
                  {field === 'primaryColor'
                    ? 'Cor Principal'
                    : field === 'primaryColorHover'
                      ? 'Cor Hover'
        ...
        <section
          ...
          style={{ borderColor: theme.primaryColor || '#00A082' }}
        >
          <div
            className="p-3 text-xs text-white font-medium"
            style={{ backgroundColor: theme.primaryColor || '#00A082' }}
          >
            Preview do Cardapio
          </div>
          <div
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between mt-1">
                <span className="text-xs" style={{ color: theme.textSecondaryColor || '#6B7280' }}>
                  Mussarela, tomate, manjericao
                </span>
                <span
                  className="font-bold text-xs"
                  style={{ color: theme.primaryColor || '#00A082' }}
                >
                  R$ 45,90
                </span>
              </div>
