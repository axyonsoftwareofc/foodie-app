// app/dashboard/page.tsx — DASHBOARD PREMIUM
'use client'
...
export default function DashboardPage() {
    ...
    useEffect(() => {
        ...
        ]).then(([statsResult, profileResult]) => {
    ...
    const cards = useMemo(() => [
        ...
        },
        {
            ...
            sub: stats?.totalToday ? `Ticket medio: ${formatCurrency(stats.revenueToday / Math.max(stats.totalToday, 1))}` : '',
            icon: TrendingUp,
        ...
        {
            label: 'Status',
            value: restaurant?.status === 'OPEN' ? '🟢 Aberto' : restaurant?.status === 'CLOSED' ? '🔴 Fechado' : '🟡 Ocupado',
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <Link href="/dashboard/menu" className="bg-white rounded-xl border border-gray-200 p-5 hover:border-emerald-300 hover:shadow-md transition-all flex items-center gap-4 group">
                ...
                <Link href="/dashboard/cozinha" className="bg-white rounded-xl border border-gray-200 p-5 hover:border-emerald-300 hover:shadow-md transition-all flex items-center gap-4 group">
                ...
                <Link href="/dashboard/pass" className="bg-white rounded-xl border border-gray-200 p-5 hover:border-emerald-300 hover:shadow-md transition-all flex items-center gap-4 group">
            ...
            {(!stats || stats.totalToday === 0) && (
                <div className="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-xl p-6 text-white">
                    ...
                    <p className="text-emerald-100 mb-4 max-w-xl">
                        Compartilhe o link do seu cardapio com seus clientes e comece a receber pedidos hoje mesmo.
                    </p>
