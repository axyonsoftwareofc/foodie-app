...
import { tenantStep1Schema, CATEGORY_OPTIONS, type TenantStep1Data } from '@/lib/validations/tenant.validations'
...
function getStep1Data(): TenantStep1Data {
    ...
    try {
        ...
        return raw ? JSON.parse(raw) : { name: '', category: '', phone: '', email: '', description: '' }
    } catch {
        return { name: '', category: '', phone: '', email: '', description: '' }
    }
}
