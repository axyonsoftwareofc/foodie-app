...
export function OrderCard({ order, onAction, onClick }: OrderCardProps) {
  ...
  const getItemsSummary = (items: OrderItem[]) => {
    ...
    if (items.length === 1) return items[0].name || items[0].productName || items[0].menuItemName || '1 item';
      ...
      >
        ...
        <div className="px-4 py-3 bg-gray-50 border-b border-gray-100">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
            <span className={`text-xs px-2 py-0.5 rounded-full ${getOrderTypeColor(order.orderType)}`}>
