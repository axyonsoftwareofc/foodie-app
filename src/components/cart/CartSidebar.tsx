...
export default function CartSidebar() {
  const { items, restaurantId, updateQuantity, totalPrice, setIsCartOpen } = useCart();
      ...
      >
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span
              className={deliveryFee === 0 ? 'text-[#00A082]' : ''}
              style={{ color: deliveryFee === 0 ? undefined : 'var(--color-text)' }}
            >
