...
export function DeliveryCalculator({
  ...
  useEffect(() => {
    ...
    if (onFeeCalculated) {
      onFeeCalculated(restaurantConfig.deliveryFee, 0, restaurantConfig.estimatedTime, true);
    }
      ...
      {distance !== null && (
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            <span style={{ color: 'var(--color-text-secondary)' }}>Distância:</span>
          ...
          {!isWithinRadius ? (
            ...
            >
              <p className="text-sm font-medium">⚠️ Endereço fora da área de entrega</p>
              <p className="text-xs mt-1">Raio máximo: {restaurantConfig.deliveryRadius} km</p>
            </div>
          ) : (
            <>
              <div className="flex items-center justify-between text-sm">
              ...
              <div className="flex items-center justify-between text-sm">
                <span style={{ color: 'var(--color-text-secondary)' }}>Tempo estimado:</span>
                <span className="font-medium" style={{ color: 'var(--color-text)' }}>
                  {estimatedTime}
                </span>
              </div>
