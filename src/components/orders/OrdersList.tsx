...
export function OrdersList() {
  ...
  useEffect(() => {
    const loadOrders = async (): Promise<void> => {
      ...
      const hasActive = (result.data || []).some((o) => ACTIVE_STATUSES.includes(o.status));
        ...
        >
          ...
          {orders.length > 0 && (
            <button
              ...
              style={{
                backgroundColor: showSearch ? '#00A082' : 'var(--color-bg-secondary)',
          ...
          <>
            ...
            >
              <button
                ...
                style={{
                  backgroundColor: activeTab === 'active' ? 'var(--color-bg-card)' : 'transparent',
                  color: activeTab === 'active' ? '#00A082' : 'var(--color-text-secondary)',
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    activeTab === 'completed' ? 'var(--color-bg-card)' : 'transparent',
                  color: activeTab === 'completed' ? '#00A082' : 'var(--color-text-secondary)',
